...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
      <h1 className="text-3xl font-bold mb-6">Generate Website</h1>

      <form
        onSubmit={handleSubmit}
        className="bg-gray-800 p-6 rounded-2xl shadow-md w-80 flex flex-col gap-4"
      >
        <label>
          <span className="block mb-1">Directory Name</span>
          <input
            type="text"
